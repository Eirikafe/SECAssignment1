...
public class JFXArena extends Pane
{
    ...
    private static final String IMAGE_FILE = "1554047213.png", FORTRESS_FILE = "rg1024-isometric-tower.png";
    private Image robot1, fortress1;
    ...
    public JFXArena()
    {
        ...
        is = getClass().getClassLoader().getResourceAsStream(FORTRESS_FILE);
        if(is == null)
        {
            throw new AssertionError("Cannot find image file " + FORTRESS_FILE);
        }
        fortress1 = new Image(is);
        canvas = new Canvas();
        canvas.widthProperty().bind(widthProperty());
        canvas.heightProperty().bind(heightProperty());
        getChildren().add(canvas);
        
        Thread rt = new Thread(rf, "robot factory");
        rt.start();
        try
        {
            robot = rf.getNextRobot();
        }
            ...
            setOnMouseClicked(event ->
            {
                ...
                if(gridX < gridWidth && gridY < gridHeight)
                {
                    ...
                    {   
                        ...
                        {
                            drawImage(gfx,null,gridX,gridY);
                        }
                        requestLayout();*/
                    }
                }
    ...
    public void layoutChildren()
    {
        ...
        drawLabel(gfx, Integer.toString(robot.getLabel()), robotX, robotY);
        drawImage(gfx, fortress1, 4, 4);
    }
